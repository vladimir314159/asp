...
def queen4(filename,numberblocked,start,sub):
    ...
    if sub:
        ...
        mystring="gringo "+filename+" "+str(file_name1)+" --const n=" +str(int(start))+" | clasp 1"
    print(mystring)
    t=0
...
def queen11(filename,numberblocked,start,sub):
